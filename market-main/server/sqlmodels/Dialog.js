...
module.exports = class User extends Sequelize.Model {
    ...
    return super.init(
      {
        ...
        chat_id: {
          type: Sequelize.INTEGER, // STRING : MySQL의 VARCHAR
        },
        senderId: {
          type: Sequelize.INTEGER, // STRING : MySQL의 VARCHAR
        },
      ...
      },
      {
        ...
        modelName: "Dialog", // 모델 이름
        tableName: "dialog", // 테이블 이름
  ...
  //관계 설정 JOIN
  static associate(db) {
    db.Dialog.belongsTo(db.User, { foreignKey: "senderId", targetKey: "id" });
    db.Dialog.belongsTo(db.ChatRoom, { foreignKey: "chat_id", targetKey: "id" });
  }
};